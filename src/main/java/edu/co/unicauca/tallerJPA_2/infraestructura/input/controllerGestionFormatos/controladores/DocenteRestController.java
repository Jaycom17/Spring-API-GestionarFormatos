...
public class DocenteRestController {
    ...
    public DocenteRestController(GestionarDocenteCUIntPort objGestionarDocenteCUIntPort, @Qualifier("DocenteMapperInfraestructuraDominio") ModelMapper objMapeador) {
...
public ResponseEntity<List<DocenteDTORespuesta>> listarDocentesPorGrupo(
    ...
    List<DocenteDTORespuesta> respuesta = objMapeador.map(
        ...
        new TypeToken<List<DocenteDTORespuesta>>() {}.getType()
    );
