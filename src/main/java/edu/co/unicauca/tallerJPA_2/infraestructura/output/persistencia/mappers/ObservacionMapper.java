...
public class ObservacionMapper {
    ...
    @Bean("ObservacionesMapperPersistenciaDominio")
    public ModelMapper crearObservacionesMapper() {
        ModelMapper modelMapper = new ModelMapper();
        ...
        typeMap.addMappings(mapper -> {
            ...
            mapper.using(ctx -> {
                ...
                FormatoA formatoA = new FormatoppA();

                formatoA.setIdFormatoA(entity.getObjFormatoA().getIdFormatoA());
                formatoA.setTitulo(entity.getObjFormatoA().getTitulo());
                formatoA.setFechaCreacion(entity.getObjFormatoA().getFechaCreacion());

                Estado estado = new Estado();
                estado.setIdEstado(entity.getObjFormatoA().getObjEstado().getIdEstado());
                estado.setEstadoActual(entity.getObjFormatoA().getObjEstado().getEstadoActual());

                formatoA.setObjEstado(estado);
